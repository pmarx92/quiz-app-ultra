...
function App() {
  const [allCards, setAllCards] = useState(
    loadLocalStorage("localSavedCards") ?? cardArray
  );
  ...
  const removeFromBookmarkedList = (id) => {
    const changeBookmarkStatus = setAllCards(
  ...
  return (
    <div className="App">
        ...
        <Route
          ...
          element={
            <Cards
              ...
              removeFromBookmarkedList={removeFromBookmarkedList}
            />
          }
        />
        <Route
          ...
          element={
            <Bookmarks
              cards={allCards.filter((card) => card.bookmarked)}
              removeFromBookmarkedList={removeFromBookmarkedList}
              handleBookmark={handleBookmark}
            />
          }
      ...
      <Footer
        setshowActivePage={setshowActivePage}
